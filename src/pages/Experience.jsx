  ...
  const experiences = [
    {
      ...
      bullets: [
        "Joined as a founding engineer to build the product from 0→1, owning full stack end-to-end across web & mobile",
        "Built and scaled the core platform using Next.js, Nest.js, and Firebase, consumer-facing features & an internal admin dashboard",
        "Expanded the platform to iOS and Android, taking on full-stack mobile development as the product scaled beyond web",
        "Built the Communities feature end-to-end, enabling users to create public/private groups, send invites, and manage join requests",
        "Improved frontend and backend performance by ~30%, triaged production issues, & owned UI/UX execution from Figma to production"
      ],
